    ...
    <div className="rounded-lg bg-zinc-950 p-4">
      ...
      <div className="mt-4">
        ...
        <Slider
          ...
          step={1}
          onValueChange={handleSliderChange}  // Handle value change while dragging
        onChange={handleSliderCommit}  // Commit the final value when interaction ends
          className="mt-2"
        />
      </div>
      <div className="mt-4 flex items-center justify-center gap-4">
        ...
        <Button onClick={onPrevious} size="icon" variant="ghost" className="h-8 w-8 text-white/60 hover:text-white">
        ...
        <Button
          ...
          size="icon"
          variant="ghost"
          className="h-12 w-12 rounded-full bg-white text-black hover:bg-white/90 hover:text-black"
        >
          {isPlaying ? <Pause className="h-6 w-6" /> : <Play className="h-6 w-6" />}
        </Button>
        <Button onClick={onNext} size="icon" variant="ghost" className="h-8 w-8 text-white/60 hover:text-white">
